...
/**
 * The idea behind SRP is to force you to put a single responsibility or 'concern' into a single
 * class, avoiding god objects, which are hard to refactor, maintain
 */
