...
public class Demo {
  public static void main(String[] args) {
    ...
    ColoredShape coloredCircle = new ColoredShape(new Circle(2), "blue");
    System.out.println(coloredCircle.info());
    TransparentShape coloredTransparentSquare =
        new TransparentShape(22, new ColoredShape(new Square(2), "blue"));
    System.out.println(coloredTransparentSquare.info());

    StaticColorShapeDecorator<Circle> cir =
        new StaticColorShapeDecorator<>(() -> new Circle(2), "ss");
  }
}

class StaticColorShapeDecorator<T extends Shape> implements Shape {
  private Shape shape;
  private String color;

  public StaticColorShapeDecorator(Supplier<? extends T> s, String color) {
    this.shape = s.get();
    this.color = color;
  }
...
class TransparentShape implements Shape {
  ...
  public TransparentShape(int transparency, Shape shape) {
  ...
  @Override
  public String info() {
    return "Transparency for " + shape.info() + " is " + transparency + "%";
  }
}
...
class StringDecorator {
  ...
  public long getNumberOfVowels() {
    return this.string
        .chars()
        .mapToObj(c -> (char) c)
        .filter(c -> "aeoiu".contains(c.toString()))
        .count();
  }
